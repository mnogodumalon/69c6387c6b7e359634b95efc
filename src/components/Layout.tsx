...
const navigation = [
  ...
  { name: 'Haupt-Prompt', href: '/haupt-prompt', icon: IconFileText },
  { name: 'Nachbesserung', href: '/nachbesserung', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Haupt-Prompt', href: '/gateway/apps/69c6386b31076725d66a18c5?template=list_page', icon: IconFileText },
  { name: 'Nachbesserung', href: '/gateway/apps/69c6386f252dfa516befa887?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c6386b31076725d66a18c5?template=list_page"
